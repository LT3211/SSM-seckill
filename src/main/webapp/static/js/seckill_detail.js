...
var seckill = {
    ...
    URL: {
        now: function () {
            return getRootPath()+'/seckill/time/now';
        },
        exposer: function(seckillId){
            return getRootPath()+'/seckill/' + seckillId + '/exposer';
        },
        execution : function(seckillId, md5){
            return getRootPath()+'/seckill/' + seckillId + '/' + md5 + '/execution';
        }
    },
    //验证手机号
            ...
            if (!seckill.validatePhone(killPhone)) {
                ...
                $("#killPhoneBtn").click(function () {
                    ...
                    if (seckill.validatePhone(inputPhone)) {
                        //将手机号写入cookie
                        $.cookie('killPhone', inputPhone, {expires: 7, path: '/SSM_seckill_war/seckill/'});
                        //刷新页面
